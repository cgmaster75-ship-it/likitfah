        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex items-center justify-between h-14 md:h-16">
                <div class="flex items-center gap-3 cursor-pointer" onclick="window.location.href='dashboard.html'">
                    <img src="img/logo-likitfah.png" alt="ลิขิตฟ้า" class="w-8 h-8 md:w-10 md:h-10 rounded-full border border-amber-500/50 shadow-[0_0_10px_rgba(245,158,11,0.5)] object-cover">
                ...
                <div class="flex items-center gap-2">
                    <button onclick="window.location.href='donate.html'" class="text-[10px] md:text-xs px-3 py-1.5 rounded-full border border-rose-500/50 bg-rose-500/20 hover:bg-rose-500/40 text-rose-200 transition-all font-medium flex items-center shadow-[0_0_10px_rgba(225,29,72,0.3)]" style="font-family: 'Prompt', sans-serif;">
                        <i class="fa-solid fa-mug-hot mr-1.5 text-rose-400"></i><span class="hidden sm:inline">เลี้ยงกาแฟ</span>
                    </button>

                    <button onclick="window.location.href='dashboard.html'" class="text-[10px] md:text-xs px-3 py-1.5 rounded-full border border-amber-500/40 bg-amber-500/10 hover:bg-amber-500/20 text-amber-400 transition-all font-medium" style="font-family: 'Prompt', sans-serif;">
